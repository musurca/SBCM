...
namespace SBCM
{
	...
	public class Battalion
	{
        ...
        public static void AveragePosition(List<Unit> unitList, out int utm_x, out int utm_y)
		{
            int num_samples = 0;
            int sum_utm_x = 0;
            int sum_utm_y = 0;
	...
	public class Force
	{
		...
		Dictionary<string, int> _ammoReserve;
		...
		public void InitializeAmmoReserve(double pctCapacity=0.0)
		{
			Dictionary<string, int> capacity = GetAmmoCapacity();

			_ammoReserve = new Dictionary<string, int>();
			foreach(string ammoName in capacity.Keys)
			{
				_ammoReserve.Add(ammoName, (int)(capacity[ammoName] * pctCapacity));
			}
        }

        public Dictionary<string, int> GetAmmoReserve()
		{ 
			return _ammoReserve;
        }
    }
